...
sf::VertexArray run() {
...

    {
        ...
        for(int i = 0; i < ntri; i++){
            ...
            v_arr.append(sf::Vertex(sf::Vector2f(p[v[i].p1].x, p[v[i].p1].y), sf::Color::Red));

            v_arr.append(sf::Vertex(sf::Vector2f(p[v[i].p2].x, p[v[i].p2].y), sf::Color::Red));

            v_arr.append(sf::Vertex(sf::Vector2f(p[v[i].p2].x, p[v[i].p2].y), sf::Color::Red));

            v_arr.append(sf::Vertex(sf::Vector2f(p[v[i].p3].x, p[v[i].p3].y), sf::Color::Green));
            ...
            center.x = (p[v[i].p1].x + p[v[i].p2].x + p[v[i].p3].x) / 3;
            center.y = (p[v[i].p1].y + p[v[i].p2].y + p[v[i].p3].y) / 3;

            v_arr.append(sf::Vertex(center, sf::Color::White));
    ...
    p = NULL;
    v = NULL;
    v_arr.setPrimitiveType(sf::PrimitiveType::Lines);
    return v_arr;
}
